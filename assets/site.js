(function () {
  ...
  function renderPage() {
    if (page === 'home') {
      renderParagraphs('[data-home-intro]', data.home?.intro || []);
      renderNewsList('[data-news-list]', data.home?.news || []);
      renderNewsList('[data-awards-list]', data.home?.awards || []);
    }
    if (page === 'research') {
      renderParagraphs('[data-research-overview]', data.research?.overview || []);
    ...
    if (page === 'presentations') {
      renderParagraphs('[data-talks-overview]', data.presentations?.overview || []);
      renderPresentationList('[data-talk-list]', data.presentations?.talks || []);
    }
    if (page === 'teaching') {
      renderParagraphs('[data-teaching-overview]', data.teaching?.overview || []);
